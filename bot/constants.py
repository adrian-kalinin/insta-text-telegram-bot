...
class Message:
    start = (
        'Привет! Это — самый полезный бот, когда нужен классный и красивый шрифт для соцсетей. Их здесь 50+.\n\n'
        'Также бот очень полезен для Инстаграма:\n\n'
        '• «Форматировать текст» — разделить текст на абзацы, сделать красную строку или центрировать.\n'
        '• «Антиспам» — обойти цензуру в Инстаграме и не получить бан.\n'
